...
class ClinicCasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clinic_case" do
    assert_difference('ClinicCase.count') do
      post clinic_cases_url, params: { clinic_case: { caseEvolution: @clinic_case.caseEvolution, clinicInformation: @clinic_case.clinicInformation, description: @clinic_case.description, extraInformation: @clinic_case.extraInformation, title: @clinic_case.title, topic_id: @clinic_case.topic_id } }
    end
  ...
  test "should update clinic_case" do
    patch clinic_case_url(@clinic_case), params: { clinic_case: { caseEvolution: @clinic_case.caseEvolution, clinicInformation: @clinic_case.clinicInformation, description: @clinic_case.description, extraInformation: @clinic_case.extraInformation, title: @clinic_case.title, topic_id: @clinic_case.topic_id } }
