...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { degree: @professor.degree, field: @professor.field, formation: @professor.formation, person_id: @professor.person_id } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { degree: @professor.degree, field: @professor.field, formation: @professor.formation, person_id: @professor.person_id } }
